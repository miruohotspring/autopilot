...
assert_file_contains "$state1/tmux.log" "\$ap-self-recognition"
assert_file_contains "$state1/tmux.log" "\$ap-briefing"
...
assert_file_contains "$state3/tmux.log" "\$ap-self-recognition"
